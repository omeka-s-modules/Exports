...
interface ExporterInterface
{
     ...
     *
     * The export job will make a temporary directory and invoke this method.
     * This method should do the export and place all assets into that directory.
     * The export job will then ZIP up the export directory, copy the file to
     * Omeka file storage, and delete any leftover server artifacts.
     */
